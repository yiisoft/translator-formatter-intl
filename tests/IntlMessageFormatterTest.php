...
namespace Yiisoft\Translator\Formatter\Intl\Tests;
...
_MSG_
     ...
     */
    public function testParseNamedArguments(string $expected, string $pattern, array $args, string $locale = 'en-US'): void
    {
